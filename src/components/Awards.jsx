  ...
  return (
    <Layout>
      <Box sx={{ p: 3 }}>
        ...
        <Typography gutterBottom sx={{ fontWeight: "bold", color: "#be8f2d" }}>
        ...
        <ol>
          ...
          <li>
            Nominee must have their videos or contents on social media (Youtube,
        ...
        <Typography>
          This Nomination is open to those who are worthy of honor & recognized
          in the various listed categories. Anyone can be nominated so long as
          he/she satisfies the criteria above. Take note of the following:
        </Typography>
        <ol>
